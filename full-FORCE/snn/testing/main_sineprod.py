# main_sineproduct.py - main script for learning product of sines function
#
#	created: 8/15/2021
...
test(Network=N, f=f, f_out=f_out, h=h, init_trials=init_trials, snapshot_len=snapshot_len, dur=dur, f_name="results\\results.txt", \
		model_message=f"Product of Sines {N_neurons} Neurons, 100 Trials, 1 second Trial Duration", png_name=f"results\\sineprod\\prod_{N_neurons}N.png")