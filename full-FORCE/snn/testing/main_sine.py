# main_sine.py - main script for learning sine function
#
#	created: 8/15/2021
...
test(Network=N, f=f, f_out=f_out, h=h, init_trials=init_trials, snapshot_len=snapshot_len, dur=dur, f_name="results\\results.txt", \
		model_message=f"Sine {N_neurons} Neurons, 30 Trials, 1 second Trial Duration", png_name=f"results\\sine\\sin_{N_neurons}N.png")